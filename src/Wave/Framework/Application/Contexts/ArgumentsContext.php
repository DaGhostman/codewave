...
namespace Wave\Framework\Application\Contexts;


use Traversable;
use Wave\Framework\Application\Interfaces\ContextInterface;

class ArgumentsContext implements ContextInterface, \IteratorAggregate
{
    ...
    /**
     * @param $val mixed Resolves the type of the variable if string,
    ...
    /**
     * @param $key string Alias for fetch
     *
