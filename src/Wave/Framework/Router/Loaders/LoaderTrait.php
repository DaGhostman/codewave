...
trait LoaderTrait
{
    ...
    public function pushRoutes($router)
    {
        if (! method_exists($router, 'addRoute')) {
            throw new \LogicException('Provided router should have public method \'addRoute\'');
        }
    ...
    public function pushControllers($router)
    {
        if (! method_exists($router, 'controller')) {
            throw new \LogicException('Provided router should have public method \'controller\'');
        }
