...
class TranslateTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->testable = new Translate($translation, 'en_GB', $this->locales);
    }
    ...
    {
        $this->assertEquals($this->testable->translate('lorem Ipsum'), 'Ipsum Lorem');
    }
    ...
    {
        $this->assertEquals($this->testable->availableLocales(), array(
            'en_GB',
            'en_US',
            'bg_BG'
        ));
