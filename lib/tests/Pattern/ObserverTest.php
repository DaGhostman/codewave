...
class ObserverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCreation() {
        $this->assertInstanceOf('\Wave\Pattern\Observer\Observer', 
            new Observer($this->subj));
    }
    
    public function testStates() {
        $this->assertInstanceOf('\Wave\Pattern\Observer\Subject', 
