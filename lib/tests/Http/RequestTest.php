...
class RequestTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $req = new Request(new Environment());
    ...
    {
        $req = new Request(new Environment(array('request.method' => 'GET')));
        $this->assertTrue($req->isGet());
        
        $req = new Request(new Environment(array('request.method' => 'POST')));
        $this->assertTrue($req->isPost());
        
        $req = new Request(new Environment(array('request.method' => 'PUT')));
        $this->assertTrue($req->isPut());
        
        $req = new Request(new Environment(array('request.method' => 'DELETE')));
        $this->assertTrue($req->isDelete());
        
        $req = new Request(new Environment(array('request.method' => 'OPTIONS')));
        $this->assertTrue($req->isOptions());
        
        $req = new Request(new Environment(array('request.method' => 'TRACE')));
        $this->assertTrue($req->isTrace());
        
        $req = new Request(new Environment(array('request.method' => 'CONNECT')));
        $this->assertTrue($req->isConnect());
        
        $req = new Request(new Environment(array('request.method' => 'HEAD')));
