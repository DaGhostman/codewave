...
class Translate
{
    ...
    /**
     *
     * @var array \ArrayAccess array container
     */
     ...
     * @access public
     *        
     * @param array|ArrayAccess $translation
     *            Array with translations
     * @param string $current
     *            The currently loaded locale (Optional)
     * @param array $locales
     *            Array with available locales (Optional)
     */
     ...
     *        
     * @param string $needle
     *            The needle that needs to be translated
