...
class Request
{
     ...
     * 
     * @param array $params Array of parameters which are passed via the URI
     */
     ...
     * 
     * @param string $key The key coresponding to the parameter
     ...
     * 
     * @param array $params Array of new parameters to add
     */
